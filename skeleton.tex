...
illustrated in Figure \ref{fig:fpl_arch}. But unfortunately the  
...
The \texttt{int16\_t} layer targets the cases whewre



To detect whether an 
addition has gone overflown, the result of a conventional addition and saturated
addition is compared. With saturated add, the results always retain at maximum
possible value of int16\_t: 0x7FFF, therefore being different from the
conventional add in case of overflow. 
